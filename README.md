...
6. **File**: New… (layout), Restore previous, Open / Save JSON, Ask an LLM…, Export PNG, SVG, or PowerPoint (16:9). If the detail figure is on, PNG and SVG include that list under the picture; PowerPoint adds 16:9 slides for it, and continues onto extra slides if the copy is long.
